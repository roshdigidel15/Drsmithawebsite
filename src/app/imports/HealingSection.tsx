...
export default function HealingSection() {
  return (
    <div className="content-stretch flex items-center justify-center p-6 md:p-16 lg:p-[120px] relative w-full min-h-[300px] md:min-h-[400px]" data-name="Healing Section">
      ...
      <div className="font-['Inter:Bold',sans-serif] font-bold leading-[0] not-italic relative shrink-0 text-[#626262] text-[24px] md:text-[32px] w-full max-w-[819px] whitespace-pre-wrap">
        <div className="mb-0">
          <ImageHoverText 
