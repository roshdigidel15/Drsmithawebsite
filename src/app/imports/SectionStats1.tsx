...
function Container() {
  return (
    <div className="content-center flex flex-wrap flex-[1_0_0] gap-6 md:gap-[48px] items-center justify-center leading-[0] max-w-[1200px] min-h-px min-w-px relative text-center whitespace-nowrap w-full" data-name="container">
      <Stat />
      <Stat1 />
      <Stat2 />
      <Stat3 />
