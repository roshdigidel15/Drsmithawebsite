...
function CompanyLinksColumn() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[88px]" data-name="Company Links Column 1">
      <Link to="/" className="flex flex-col justify-center relative shrink-0 w-full hover:text-[#c96a4a] transition-colors">
        <p className="leading-[1.5] whitespace-pre-wrap">Home</p>
      </Link>
      <Link to="/about" className="flex flex-col justify-center relative shrink-0 w-full hover:text-[#c96a4a] transition-colors">
        <p className="leading-[1.5] whitespace-pre-wrap">About us</p>
      </Link>
      <Link to="/our-work" className="flex flex-col justify-center relative shrink-0 w-full hover:text-[#c96a4a] transition-colors">
...
function CompanyLinksColumn1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start min-h-px min-w-px relative" data-name="Company Links Column 2">
      <Link to="/news-events" className="flex flex-col justify-center relative shrink-0 w-full hover:text-[#c96a4a] transition-colors">
        <p className="leading-[1.5] whitespace-pre-wrap">{`News & Events`}</p>
      </Link>
      <Link to="/join-us" className="flex flex-col justify-center relative shrink-0 w-full hover:text-[#c96a4a] transition-colors">
        <p className="leading-[1.5] whitespace-pre-wrap">Join Us</p>
      </Link>
      <Link to="/contact" className="flex flex-col justify-center relative shrink-0 w-full hover:text-[#c96a4a] transition-colors">
...
function FooterLinksContainer() {
  return (
    <div className="content-stretch flex flex-col sm:flex-row gap-10 sm:gap-[64px] items-start relative shrink-0 w-full lg:w-[670px]" data-name="Footer Links Container">
      <CompanyLinks />
      <ContactInfo />
    </div>
  );
...
function SubscribeInput() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full max-w-[372px]" data-name="Subscribe input">
      <InputButton />
...
function FooterContent() {
  return (
    <div className="content-stretch flex flex-col lg:flex-row items-start justify-between gap-10 relative shrink-0 w-full max-w-[1184px]" data-name="Footer Content">
      <FooterLeftColumn />
...
function FooterBottomContent() {
  return (
    <div className="content-stretch flex flex-col sm:flex-row gap-4 items-center justify-between relative shrink-0 w-full" data-name="Footer Bottom Content">
      <FooterBottomLeft />
      <SocialIcons />
    </div>
  );
...
export default function Footer() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[40px] items-center pb-[20px] pt-[60px] px-6 md:px-16 lg:px-[120px] relative size-full" data-name="Footer">
      <FooterContent />
      <FooterBottom />
    </div>
  );
