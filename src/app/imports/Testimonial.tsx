...
function ReviewSectionTitle() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 px-4" data-name="Review Section Title">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center not-italic relative shrink-0 text-[#c96a4a] text-[24px] md:text-[32px] tracking-[-1.5px] text-center" style={{ fontFeatureSettings: "'zero', 'cv01', 'cv02', 'cv03', 'cv04', 'cv07', 'cv10', 'cv11'" }}>
        <p className="leading-[1.3]">Don't Believe Us? See review</p>
      </div>
    </div>
  );
}
...
function Review1Content() {
  return (
    <div className="capitalize content-stretch flex flex-col font-['Inter:Medium',sans-serif] font-medium gap-2 items-start justify-center not-italic relative shrink-0 tracking-[-0.5px] w-full" data-name="Review 1 Content">
      <div className="flex flex-col justify-center min-h-px min-w-px relative text-[#c96a4a] text-[24px] w-full" style={{ fontFeatureSettings: "'zero', 'cv01', 'cv02', 'cv03', 'cv04', 'cv07', 'cv10', 'cv11'" }}>
        <p className="leading-[1.5] whitespace-pre-wrap">Grandma Meera finds a home</p>
      </div>
      <div className="flex flex-col justify-center min-h-px min-w-px relative text-[#626262] text-[16px] w-full" style={{ fontFeatureSettings: "'zero', 'cv01', 'cv02', 'cv03', 'cv04', 'cv07', 'cv10', 'cv11'" }}>
...
function Review() {
  return (
    <div className="bg-[rgba(159,184,160,0.1)] content-stretch flex flex-col gap-[25px] items-start px-[24px] py-[32px] relative shrink-0 w-[320px] md:w-[580px]" data-name="Review 1">
      <Review1Header />
      <Review1Content />
    </div>
  );
...
function Review2Content() {
  return (
    <div className="capitalize content-stretch flex flex-col font-['Inter:Medium',sans-serif] font-medium gap-2 items-start justify-center not-italic relative shrink-0 tracking-[-0.5px] w-full" data-name="Review 2 Content">
      <div className="flex flex-col justify-center min-h-px min-w-px relative text-[#c96a4a] text-[24px] w-full" style={{ fontFeatureSettings: "'zero', 'cv01', 'cv02', 'cv03', 'cv04', 'cv07', 'cv10', 'cv11'" }}>
...
function Review1() {
  return (
    <div className="bg-[rgba(159,184,160,0.1)] content-stretch flex flex-col gap-[25px] items-start px-[24px] py-[32px] relative shrink-0 w-[320px] md:w-[580px]" data-name="Review 2">
      <Review2Header />
      <Review2Content />
    </div>
  );
...
function Review3Content() {
  return (
    <div className="capitalize content-stretch flex flex-col font-['Inter:Medium',sans-serif] font-medium gap-2 items-start justify-center not-italic relative shrink-0 tracking-[-0.5px] w-full" data-name="Review 3 Content">
      <div className="flex flex-col justify-center min-h-px min-w-px relative text-[#c96a4a] text-[24px] w-full" style={{ fontFeatureSettings: "'zero', 'cv01', 'cv02', 'cv03', 'cv04', 'cv07', 'cv10', 'cv11'" }}>
...
function Review2() {
  return (
    <div className="bg-[rgba(159,184,160,0.1)] content-stretch flex flex-col gap-[25px] items-start px-[24px] py-[32px] relative shrink-0 w-[320px] md:w-[580px]" data-name="Review 3">
      <Review3Header />
      <Review3Content />
    </div>
  );
...
function ReviewsContainer() {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      <motion.div
        className="flex gap-6 md:gap-[80px]"
        animate={{
          x: [0, -((580 + 80) * 3)],
        }}
        transition={{
...
export default function Testimonial() {
  return (
    <div className="relative w-full overflow-hidden bg-white" style={{ zIndex: 3 }} data-name="Testimonial">
