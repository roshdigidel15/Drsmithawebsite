...
function SocialMediaIcons() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full lg:w-[645px]" data-name="Social Media Icons">
...
function BannerText() {
  return (
    <div className="content-stretch flex flex-col lg:flex-row items-center justify-between gap-8 relative shrink-0 w-full" data-name="Banner Text">
      <SocialMediaIcons />
...
export default function HealingSection() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-6 md:px-16 lg:px-[120px] py-12 lg:py-0 relative w-full min-h-[400px] lg:min-h-[500px]" style={{ zIndex: 4 }} data-name="Healing Section">
